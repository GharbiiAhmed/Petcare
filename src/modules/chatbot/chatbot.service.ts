...
User's Pets Information:`;
  ...
  private buildDefaultPrompt(userMessage: string, context?: string): string {
    let prompt = `You are a Vet AI assistant for the Petcare pet care app. You provide veterinary advice including diagnoses, recommendations, tips, and descriptions about pet health and care. You can analyze symptoms, suggest possible conditions, and provide guidance.
...
User Question: ${userMessage}`;
  ...
  private async buildImageAnalysisPrompt(
    ...
    try {
      ...
      let prompt = `You are a Vet AI assistant for the Petcare pet care app. You will receive:
